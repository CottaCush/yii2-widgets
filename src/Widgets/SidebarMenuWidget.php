...
/**
 * Class SidebarMenu
 * @author Adebiyi Adekunle <biyi@cottacush.com>
 * @package app\widgets
 */
class SidebarMenuWidget extends Menu
{
    ...
    {
        if (isset($item['items'])) {
            $labelTemplate = '<a href="{url}">{label} <span class="pull-right-container"><i class="fa fa-angle-right"></i></span></a>';
            $linkTemplate = '<a href="{url}">{icon} {label} <span class="pull-right-container"><i class="fa fa-angle-right"></i></span></a>';
        } else {
